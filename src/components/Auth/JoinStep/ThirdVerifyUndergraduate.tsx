...
interface ThirdVerifyUndergraduateProps {
  openScanner: () => void;
  barcode: string | null;
  onNext: (hiddenCode?: string) => void;
}
    ...
    <View style={styles.container}>
      <View>
        ...
        >
          ...
          <TouchableOpacity onPress={() => setHiddenCount((c) => c + 1)}>
      ...
      <View>
        ...
        <TouchableOpacity
          onPress={() => {
            if (barcode) onNext();
            if (hiddenCode) onNext(hiddenCode);
          }}
      ...
      <Dialog.Container visible={hiddenCount >= 5}>
        ...
        <Dialog.Input
          onChangeText={(value) => setHiddenCode(value)}
          placeholder="가입코드"
        />
