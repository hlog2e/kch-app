...
export default function Comment({
  ...
  const handleCommentDelete = async ({ commentData }: { commentData: any }) => {
  ...
  const handleBlockUser = async ({ commentData }: { commentData: any }) => {
  ...
  const handleReportComment = async ({ commentData }: { commentData: any }) => {
  ...
  const handleOpenActionSheet = async (_commentData: any) => {
